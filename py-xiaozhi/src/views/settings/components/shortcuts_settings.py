...
class ShortcutsSettingsWidget(QWidget):
    ...
    def init_ui(self):
        ...
        # 启用快捷键选项
        self.enable_checkbox = QCheckBox("Bật phím tắt toàn cục")
        ...
        self.shortcut_widgets["MANUAL_PRESS"] = self.create_shortcut_config(
            "Nhấn và giữ để nói", self.shortcuts_config.get("MANUAL_PRESS", {})
        )
        ...
        self.shortcut_widgets["WINDOW_TOGGLE"] = self.create_shortcut_config(
            "Hiển thị/ẩn cửa sổ", self.shortcuts_config.get("WINDOW_TOGGLE", {})
        )
